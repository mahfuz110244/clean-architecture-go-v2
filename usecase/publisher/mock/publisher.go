...
func (m *MockReader) Get(id int64) (*entity.Publisher, error) {
	m.ctrl.T.Helper()
...
func (m *MockWriter) Create(e *entity.Publisher) (int64, error) {
	m.ctrl.T.Helper()
...
// Create mocks base method.
func (m *MockRepository) Create(e *entity.Publisher) (int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", e)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
...
// Get mocks base method.
func (m *MockRepository) Get(id int64) (*entity.Publisher, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", id)
	ret0, _ := ret[0].(*entity.Publisher)
	ret1, _ := ret[1].(error)
...
func (m *MockUseCase) CreatePublisher(name, address string) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockUseCase) DeletePublisher(id int64) error {
	m.ctrl.T.Helper()
...
func (m *MockUseCase) GetPublisher(id int64) (*entity.Publisher, error) {
	m.ctrl.T.Helper()
