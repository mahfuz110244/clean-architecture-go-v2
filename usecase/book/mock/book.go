...
func (m *MockWriter) Create(e *entity.Book) (int64, error) {
	m.ctrl.T.Helper()
...
// Create mocks base method.
func (m *MockRepository) Create(e *entity.Book) (int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", e)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
...
func (m *MockUseCase) CreateBook(title, author string, pages, quantity int) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockUseCase) DeleteBook(id int64) error {
	m.ctrl.T.Helper()
...
func (m *MockUseCase) GetBook(id int64) (*entity.Book, error) {
	m.ctrl.T.Helper()
