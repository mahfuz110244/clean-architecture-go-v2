...
create table if not exists publisher (id varchar(50), name varchar(255), address varchar(255), created_at datetime, updated_at datetime, PRIMARY KEY (`id`)) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=latin1;
